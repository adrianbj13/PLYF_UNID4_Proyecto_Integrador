...
inicio:-
	new(Menu, dialog('Proyecto Unidad 4 ITSVA', size(1000,800))),
	new(L,label(nombre,'SISTEMA DE DIAGNOSTICO MEDICO')),
	new(A,label(nombre,'hecho por Adrian Balam Jimenez y Omar Ake Bellos')),
	new(@texto,label(nombre,'responde el cuestionario para el diagnostico')),
